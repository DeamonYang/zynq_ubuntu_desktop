...
#
# Generated by export_simulation on Sat Nov 09 11:08:44 +0800 2019
#
################################################################################
...
switch to the './clk_lvds.sh' script.

./clk_lvds.sh -reset_run
...
./clk_lvds.sh -noclean_files

For more information on the script, please type './clk_lvds.sh -help'.
