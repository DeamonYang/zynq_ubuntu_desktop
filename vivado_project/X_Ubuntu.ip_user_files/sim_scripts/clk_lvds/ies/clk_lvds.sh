...
elaborate()
{
  opts="-loadvpi "E:/Xilinx_Vivado2015/Vivado/2015.4/lib/win64.o/libxil_ncsim.dll:xilinx_register_systf" -64bit -relax -access +rwc -messages -logfile elaborate.log -timescale 1ps/1ps"
  libs="-libname unisims_ver -libname unimacro_ver -libname secureip -libname xil_defaultlib"
  ncelab $opts xil_defaultlib.clk_lvds xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.clk_lvds -input simulate.do
}
# Script usage
usage()
{
